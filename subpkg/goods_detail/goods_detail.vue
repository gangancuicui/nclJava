<template>
	<view v-if="goodsInfo.goodsName" class="container">
		<swiper :indicator-dots="true" :autoplay="true" :interval="3000" :duration="1000" :circular="true">
			<swiper-item v-for="(item, i) in goodsInfo.picss" :key="i">
				<image class="img" :src="item" @click="clickimg(i)"></image>
			</swiper-item>
		</swiper>
		<view class="goodsbox">
			...
			<view class="body">
				<view class="price">￥{{goodsInfo.goodsPrice}}<text>/500g</text></view>
	...
	export default {
		...
		methods: {
			...
			async getGoodsDetail(goodsId) {
				...
				this.latitude = parseFloat(this.goodsInfo.goodsLatitude)
				this.longitude = parseFloat(this.goodsInfo.goodsLongitude)
				this.markers = [{
					id: 1,
					latitude: this.goodsInfo.goodsLatitude,
					longitude: this.goodsInfo.goodsLongitude,
